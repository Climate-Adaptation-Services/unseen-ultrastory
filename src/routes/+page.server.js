...
export function load() {
  ...
  const datamiddellijn = dsv(',', "https://hete-nachten.s3.eu-north-1.amazonaws.com/Observatie_Eindhoven_Tmin_statistieken_Middellijn.csv")
  const datamiddellijn2050 = dsv(',', "https://hete-nachten.s3.eu-north-1.amazonaws.com/Observatie_Eindhoven_Tmin_statistieken_Middellijn_2050.csv")
  const dataconfidence = dsv(',', "https://hete-nachten.s3.eu-north-1.amazonaws.com/Observatie_Eindhoven_Tmin_statistieken_Confidence_Intervals.csv")
