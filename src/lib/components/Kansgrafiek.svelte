      ...
      d3.select(".svgkansgrafiek")
        ...
        .attr(
          ...
          d3
            .line()
            .x(function (d) {
              return xScale(d.Kans)
            })
            .y(function (d) {
              return yScale(d.vroeger)
            }),
        )
...
<div class="grafiek">
    ...
    <div class="graphtext" style="top:{`${textPaddingKans * screenHeight}px`}">
      {#if currentStepName === "scatter" || currentStepName === "kansgrafiek"}
        ...
        <p class="scroll-text-kansgraph">
          De kans op 40 graden Celsius is door klimaatverandering sterk toegenomen. Hittestatistieken voor Eindhoven laten zien hoe groot de kans is
          dat een bepaalde temperatuur in een jaar voorkomt.
        </p>
        <div class="fade-in" style="visibility:{ratioOfCsvData > 100 && currentStepName === 'kansgrafiek' ? 'visible' : 'hidden'}">
          <p class="scroll-text-kansgraph">
            Toen Niels klein was, <mark style="background: #648fff50 !important"> rond 2000,</mark> was het nagenoeg onmogelijk dat het 40 graden zou worden.
          </p>
        </div>
        <div class="fade-in" style="visibility:{ratioOfCsvData > 250 && currentStepName === 'kansgrafiek' ? 'visible' : 'hidden'}">
          <p class="scroll-text-kansgraph">
            Inmiddels, <mark style="background: #ffb00050 !important">in 2023</mark>, is de kans op 40 graden ongeveer 2%.
          </p>
        </div>
        <div class="fade-in" style="visibility:{ratioOfCsvData > 360 && currentStepName === 'kansgrafiek' ? 'visible' : 'hidden'}">
          <p class="scroll-text-kansgraph">
            <mark style="background: #93003a50 !important">In 2050</mark>, als Sem volwassen is, zal de kans op 40 graden zijn toegenomen tot ongeveer
            8%.
          </p>
        </div>
      {/if}
  ...
  <div class="sticky-div">
    <svg>
      <g class="svgkansgrafiek" transform="translate({screenWidth * grafiekPositionX},{screenHeight * grafiekPositionY})">
        ...
        <line
          ...
          stroke-width="0.3vh"
        />
        <text x={xScale(1.5)} class="axistitle" y={yScale(7)}>Kans (%)</text>
        <text
          class="axistitle"
          transform="translate({xAxisWidthRatio * screenWidth * -0.07 - 5},{yAxisScaleKans * screenHeight * 0.5} ) rotate(-90)"
          text-anchor="middle">Temperatuur (°C)</text
        >
        <line x1={xScale(100)} y1={yScale(22)} x2={xScale(0.01)} y2={yScale(22)} stroke="grey" stroke-dasharray="5,5" />
        <text class="graphtitle" x={xScale(1)} y={yScale(48)}>De kans op nachthitte per generatie</text>
        {#if ratioOfCsvData > 170 && currentStepName === "kansgrafiek"}
          <line x1={xScale(0.008)} y1={yScale(29.3855)} x2={xScale(0.008)} y2={yScale(20.3944)} stroke="grey" />
          <line x1={xScale(0.0075)} y1={yScale(29.3855)} x2={xScale(0.0085)} y2={yScale(29.3855)} stroke="grey" />
          <line x1={xScale(0.0075)} y1={yScale(20.3944)} x2={xScale(0.0085)} y2={yScale(20.3944)} stroke="grey" />
    ...
    <p class="graph-description">
      Hittestatistieken voor Eindhoven voor het klimaat van 2000, 2023 en 2050. Deze zijn berekend op basis van metingen van KNMI-station Eindhoven en
      het KNMI'14 hoge &#40;WH&#41; scenario voor 2050. Gebruikte tools:
      <a href="https://climexp.knmi.nl">KNMI Climate Explorer</a> en het
      <a href="https://www.knmi.nl/nederland-nu/KNMI14_klimaatscenarios/transformatieprogramma">KNMI'14 transformatieprogramma</a>.
    </p>
  </div>
</div>
