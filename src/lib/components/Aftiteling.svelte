<script>
  ...
  const scenes = [
    ...
    },
    {
      ...
      image:'',
      time:0.4,
      text:'Diese Geschichte basiert auf wissenschaftlichen Erkenntnissen über außergewöhnliche Wetterereignisse und auf zahlreichen Gesprächen mit Experten auf dem Gebiet der Klimaanpassung, Hitze und Krisenmanagement. Die Bilder wurden mit KI erstellt.'
    },
    {
      name:'',
      image:'',
