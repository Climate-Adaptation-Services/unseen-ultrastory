...
<div class='stepdiv'>
  <div class='scroll-text-block night' style='top:{`${0*stepSize}px`}'>
    <img class='semslaapt' style='width:250px' src={'semslaapt.jpg'} />
  ...
  <div class='scroll-text-block night' style='top:{`${0.15*stepSize}px`}'>
    <img class='nielsgaatwandelen' style='width:300px' src={'nielsgaatwandelen.jpg'} />
  ...
  <div class='scroll-text-block night' style='top:{`${0.315*stepSize}px`}'>
    <img class='dommelplantsoen' style='width:300px' src={'/static/images/dommelplantsoen.jpg'} />
