...
<div class='stepdiv'>
  <div class='scroll-text-block' style='top:{`${0.05*stepSize}px`}'>
    <img class='semslaapt' src={'/images/semslaapt.jpg'} />
    <p class='scroll-text'>Als Sem eindelijk slaapt, wil Niels niet weer in bed gaan liggen dus besluit een rondje te lopen buiten. ​</p>
  </div>

  <div class='scroll-text-block' style='right:0; top:{`${0.1*stepSize}px`}'>
    <img class='nielsgaatwandelen' src={'/images/nielsgaatwandelen.jpg'} />
