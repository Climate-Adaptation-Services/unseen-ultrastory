<script>
  ...
  const scenes = [
    ...
    },
    {
      ...
      image:'jpg',
      time:0.72,
      text:"Niels legt uit dat ze nog niet bij haar moeder zijn geweest. 'Maar we gaan nu poolshoogte nemen!' Niels en Leonie geven elkaar een haastige kus. 'Kom, Sem, mama moet werken. Wij gaan naar oma toe.'",
      class:'scroll-text'
    },
    {
      name:'leonieradeloos',
      image:'png',
      time:0.8,
      text:"Leonie kijkt om zich heen. Al die mensen die hulp nodig hebben. Ze veegt het zweet van haar voorhoofd. Hoe gaat dit verder?",
      class: 'scroll-text'
    }
  ]
