  ...
  const scenes = [
    {
      ...
      image:'png',
      time:0.2,
      text:'Niels probeert Sem in slaap te helpen met natte washandjes. De ventilator zet hij op de hoogste stand. Terwijl hij hiermee bezig is, zegt Sem: “Volgens oma werd het vroeger nooit zo heet.”  <br/> <br/> Niels: “Klopt. Toen ik zo oud was als jij, kwam dit soort hitte nooit voor. Als je mij toen had verteld dat het dagen achter elkaar boven de 40 graden zou kunnen worden, had ik dat nooit geloofd.​”​',
      class: 'scroll-text'
    }
  ]
